...
\begin{figure}[H]
    ...
    \begin{minipage}{0.25\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Capitoli/Capitolo1/A_Sostegni di curve 1.png}
    \end{minipage}
    \hspace{1cm}
    \begin{minipage}{0.25\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Capitoli/Capitolo1/A_Sostegni di curve 2.png}
    \end{minipage}
    \hspace{1cm}
    \begin{minipage}{0.25\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Capitoli/Capitolo1/A_Sostegni di curve 3.png}
    \end{minipage}
\end{figure}
\end{example}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.33\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Capitoli/Capitolo1/A_Lunghezza 1.png}
    \end{minipage}%
    \hspace{0.05\textwidth} % Spazio tra le immagini
    % Seconda immagine
    \begin{minipage}{0.33\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Capitoli/Capitolo1/A_Lunghezza 2.png}
    \end{minipage}
\end{figure}
\begin{definition}
